...
$router->post("#^search$#", 'PagesController@postSearch');
...
$router->get("#^reset-password$#", 'PagesController@resetPassword');
$router->post("#^reset-password$#", 'PagesController@submitResetPassword');
